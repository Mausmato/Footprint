...
Spend = sl.slider("How much money are you willing to spend anually to lower your CO2 emissions? (In $)", 0, 1000)


if Spend > 0:
    sl.write(f"Your current annual CO2 emissions in tonnes/year:"+str(total))
...
# selected_strategy = sl.radio("Select a carbon reduction strategy to learn more about!:", list(strategies.keys()))
